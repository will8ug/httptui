...
import { useApp, useInput, useStdout, type SuspendTerminal } from 'ink';
...
export function App(props: AppProps): React.ReactElement {
  ...
  useInput((input, key) => {
      ...
      if (input === 'y') {
        ...
        switch (pendingAction) {
          ...
          case 'quit':
            ...
            break;
          case 'editorHandoff':
            void performEditorHandoff({ filePath: state.filePath, editor: state.editor, suspend: suspendTerminal, dispatch });
            break;
        }
        return;
      }
    ...
    if (input === 'p') {
      void pasteFromClipboard({ clipboardReadRunner: props.clipboardReadRunner, dispatch });
      return;
    }
    ...
    if (key.return) {
      void sendSelectedRequest({ state, executorConfig: props.executorConfig, abortControllerRef, dispatch });
      return;
    }
