...
export const SHORTCUTS: readonly Shortcut[] = [
  ...
  { key: 'p', label: '', description: 'Paste curl command as request', showInBar: false, showInHelp: true, group: 'request' },
  ...
  { key: 'Ctrl+G', label: '', description: 'Edit requests externally', showInBar: false, showInHelp: true, group: 'edit' },
