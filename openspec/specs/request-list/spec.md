...
The left request-list panel showing all parsed requests from the loaded file as `METHOD /path` entries, with the selected request highlighted and vertical/horizontal scrolling when content exceeds the panel bounds.
